...
const ChatWidget = ({ reportData }) => {
    ...
    return (
        <div className="fixed bottom-4 right-4 md:right-12 z-[9999] flex flex-col items-end pointer-events-none">
            ...
            {isOpen && (
                <div className="pointer-events-auto bg-white rounded-[2rem] shadow-[0_40px_100px_rgba(0,0,0,0.15)] border border-purple-50 w-[calc(100vw-2rem)] md:w-[420px] h-[min(85vh,750px)] flex flex-col overflow-hidden animate-in zoom-in-95 fade-in duration-500 origin-bottom-right">
