...
const AppLayout = ({ children }) => {
    ...
    return (
        <div className="min-h-screen text-primary selection:bg-purple-500/30 relative overflow-x-hidden">
            ...
            <div className="fixed top-20 left-10 w-64 h-64 bg-purple-600/10 rounded-full blur-3xl -z-10 animate-pulse"></div>
            <div className="fixed bottom-20 right-10 w-96 h-96 bg-blue-600/5 rounded-full blur-3xl -z-10 animate-pulse" style={{ animationDelay: '2s' }}></div>
        </div>
    );
};
