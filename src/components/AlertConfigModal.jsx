            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                <div className="bg-gradient-to-r from-amber-500 to-orange-500 px-6 py-4 flex items-center justify-between text-white">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-bold text-lg">Alert Settings</h3>
                    </div>
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-amber-500 outline-none transition-all placeholder:text-slate-300"
                        />
                        <p className="text-xs text-slate-500">Number where alerts will be sent.</p>
                    </div>

                    <div className="space-y-3">
                        <h4 className="text-sm font-semibold text-slate-700 flex items-center gap-2">
                            <Clock className="w-4 h-4 text-slate-500" /> Frequency
                        </h4>
                        ...
                        <label className="flex items-center justify-between p-3 rounded-xl border border-slate-200 hover:bg-slate-50 cursor-pointer transition-colors group">
                            <div className="flex items-center gap-3">
                                <div className={`p-2 rounded-full transition-colors ${alertDaily ? 'bg-amber-100 text-amber-600' : 'bg-slate-100 text-slate-400 group-hover:bg-white'}`}>
                                    <Clock className="w-4 h-4" />
                                </div>
                                <div>
                                    <div className="font-medium text-slate-900">Daily Insights</div>
                                    <div className="text-xs text-slate-500">Daily horoscope & guidance</div>
                                </div>
                            </div>
                            <input
                                type="checkbox"
                        ...
                        <label className="flex items-center justify-between p-3 rounded-xl border border-slate-200 hover:bg-slate-50 cursor-pointer transition-colors group">
                            <div className="flex items-center gap-3">
                                <div className={`p-2 rounded-full transition-colors ${alertWeekly ? 'bg-purple-100 text-purple-600' : 'bg-slate-100 text-slate-400 group-hover:bg-white'}`}>
                                    <Calendar className="w-4 h-4" />
                                </div>
                                <div>
                                    <div className="font-medium text-slate-900">Weekly Forecast</div>
                                    <div className="text-xs text-slate-500">Major transits & predictions</div>
                                </div>
                            </div>
                            <input
                                type="checkbox"
                        ...
                        <label className="flex items-center justify-between p-3 rounded-xl border border-slate-200 hover:bg-slate-50 cursor-pointer transition-colors group">
                            <div className="flex items-center gap-3">
                                <div className={`p-2 rounded-full transition-colors ${alertMonthly ? 'bg-indigo-100 text-indigo-600' : 'bg-slate-100 text-slate-400 group-hover:bg-white'}`}>
                                    <Calendar className="w-4 h-4" />
                                </div>
                                <div>
                                    <div className="font-medium text-slate-900">Monthly Overview</div>
                                    <div className="text-xs text-slate-500">Deep dive into the month ahead</div>
                                </div>
                            </div>
                            <input
                                type="checkbox"
                    ...
                    <div className="pt-2">
                        <button
                            onClick={handleSave}
                            disabled={loading}
                            className="w-full py-3 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white font-bold rounded-xl shadow-lg shadow-amber-500/20 transition-all flex items-center justify-center gap-2 transform active:scale-95"
                        >
